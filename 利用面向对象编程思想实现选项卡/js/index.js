...
//#region 
// 利用面向对象的编程思想创建一个选项卡
function CreateTab(headDom, contentDom) {
    // 存储数据
    // 存储选项卡顶部按钮
...
//#region 
// 为选项卡顶部按钮添加点击事件
CreateTab.prototype.addEvents = function () {
...
// 点击事件处理函数
CreateTab.prototype.handlerClick = function (getIndex) {
...
// 移除所有类名函数
CreateTab.prototype.clearClassNames = function () {
    for (let i = 0; i < this.headEles.length; i++) {
...
// 鼠标控制自动播放
CreateTab.prototype.mouseControl = function () {
    // 当鼠标移入时, 停止自动播放
